...
import com.clone.twitter.userservice.service.csv.CSVFileService;
import com.clone.twitter.userservice.service.csv.CsvFileConverter;
...
public class UserController {
    ...
    public UserDto createUser(@ParameterObject @RequestBody @Valid UserDto userDto){
        profilePictureService.generateAndSetPic(userDto);
